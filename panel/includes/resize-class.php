...
# ========================================================================#
function resizeImage($image, $width, $height, $option){  //options: exact, portrait, landscape, auto, crop)
    if ($_SESSION['sysConfig']['ImageResize'] == 'true') {
        $fileExtention      = strtolower(pathinfo($image)['extension']);
...
class resize
{
    ...
    public function resizeImage($newWidth, $newHeight, $option="auto")
    {
        ...
        if ($option == 'crop') {
            ...
            Cropping image: {$optimalWidth}x{$optimalHeight} -> {$newWidth}x{$newHeight}";
